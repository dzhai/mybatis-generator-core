 ...
 * 
 */
public class InsertBatchSelectiveMethodGenerator extends
        AbstractJavaMapperMethodGenerator {

    public InsertBatchSelectiveMethodGenerator() {
        super();
    }
    ...
    public void addInterfaceElements(Interface interfaze) {
        ...
        method.setName(introspectedTable.getInsertBatchSelectiveStatementId());
        ...
        if (context.getPlugins().clientInsertBatchSelectiveMethodGenerated(
